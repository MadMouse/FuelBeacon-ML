...
imageIn = Image.open("./PetrolPrices/petrolPriceCrop6.png")
...
imageGray.save("./SavedOutcomesPPReading/imageSave6.png")
...
print('Grayscaled, Resized, Brightened and Contrasted Image Analysis', imageExtractedText2)
custom_config = r'-c tessedit_char_whitelist=0123456789 --psm 6'
